...
# 문자열 -> 실수
str2 = "3.141592"
f1 = float(str2)     # f1 = "3.141592" => f1 = 3.141592
...
# 실수 -> 정수
f3 = 9.99
i3 = int(f3)         # 9.99 -> 9    // 소수점 아래로 버림 처리
print("f3 -> i3 : ", i3, type(i3))
...
print(bool(1))
print(bool(55))
# 정수 -> 불리언 변환시 0인 경우 false 그 외에는 True 